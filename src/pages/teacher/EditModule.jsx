// src/pages/teacher/EditModule.jsx
...
export default function EditModule() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/module/update/${moduleId}`, {
        method: 'PUT',
        headers: {
  ...
  if (loading) return <div className="min-h-screen bg-[#0a0f1a] text-gray-200 flex items-center justify-center">Loading module...</div>;
    ...
    <div className="min-h-screen bg-[#0a0f1a] text-gray-200 font-sans">
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        <div className="bg-[#11161f] border border-[#1e2330] rounded-xl p-6">
          <h2 className="text-2xl font-bold text-white mb-6">Edit Module</h2>
